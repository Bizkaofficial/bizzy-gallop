  ...
  return (
    ...
    <div>
        ...
        <p>
          ...
          pulvinar purus ultricies posuere nisi justo, placerat cum pellentesque
          primis tempus accumsan aenean. Cras mattis sociosqu accumsan lobortis
          penatibus et odio tempus, suscipit
        </p>
      </div>
      <div>
        <img src={Frame47} alt="" width={575} height={250}/>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sagittis</p>
      </div>
    </div> 
    <div className="d-flex">
